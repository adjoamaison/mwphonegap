...
function login(){
  ...
  var strUrl = "http://cs.ashesi.edu.gh/~csashesi/class2016/agatha-maison/MWC/mwfinal/response.php?cmd=16&name="+name+"&pword="+pword;
...
function addChef(){
  ...
  var strUrl = "http://cs.ashesi.edu.gh/~csashesi/class2016/agatha-maison/MWC/mwfinal/response.php?cmd=5&name="+name+"&pword="+pword+"&number="+num+"&address="+ad+"&email="+cemail;
  var objResult=sendRequest(strUrl);
